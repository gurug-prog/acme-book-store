import type { AuthorLookupDto, BookDto, CreateUpdateBookDto, PublisherLookupDto } from './models';
...
export class BookService {
  ...
  getPublisherLookup = (config?: Partial<Rest.Config>) =>
    this.restService.request<any, ListResultDto<PublisherLookupDto>>({
      method: 'GET',
      url: '/api/app/book/publisher-lookup',
    },
    { apiName: this.apiName,...config });
